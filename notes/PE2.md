...
2. Create Rmd file and write a very short summary about that. 
...
3. Save this file in a directory under the name `task1`, commit it to Git and push to Github.
Please note, that RStudio has small GUI for Git. It is avalible if you create a project (insted of plain Rmd file).
